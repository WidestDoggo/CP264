 ...
 *
 * @param source - pointer to a BST
 * @param items - array of items: length must be at least the count of items in source
 */
...
/**
 * Determines if source and target contain the same values in same configuration.
 *
 * @param target - pointer to a BST
 * @param source - pointer to a BST
